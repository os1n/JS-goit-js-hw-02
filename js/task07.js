...
const addLogin = function (allLogins, login) {
  ...
  if (!isLoginUnique(logins, login)) return "Такой логин уже используется!"; // check for unique

  if (!isLoginValid(login)) return "Ошибка! Логин должен быть от 4 до 16 символов"; // check for length
